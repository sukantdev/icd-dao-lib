...
@Embeddable
public class CrApplSuplmFrmsPK implements Serializable {
    ...
    public CrApplSuplmFrmsPK() {
    }

    public CrApplSuplmFrmsPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CrApplSuplmFrmsPK)) {
            return false;
        }
        CrApplSuplmFrmsPK other = (CrApplSuplmFrmsPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.CrApplSuplmFrmsPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
