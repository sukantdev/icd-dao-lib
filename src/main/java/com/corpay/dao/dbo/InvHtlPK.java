 ...
 */
@Embeddable
public class InvHtlPK implements Serializable {
    ...
    public InvHtlPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvHtlPK)) {
            return false;
        }
        InvHtlPK other = (InvHtlPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvHtlPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
