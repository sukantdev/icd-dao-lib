 ...
 */
@Embeddable
public class InvAdjmPK implements Serializable {
    ...
    public InvAdjmPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvAdjmPK)) {
            return false;
        }
        InvAdjmPK other = (InvAdjmPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvAdjmPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
