 ...
 */
@Embeddable
public class FmrmOther2PK implements Serializable {
    ...
    public FmrmOther2PK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmOther2PK)) {
            return false;
        }
        FmrmOther2PK other = (FmrmOther2PK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmOther2PK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
