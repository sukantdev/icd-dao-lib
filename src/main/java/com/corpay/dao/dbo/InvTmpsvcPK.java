 ...
 */
@Embeddable
public class InvTmpsvcPK implements Serializable {
    ...
    public InvTmpsvcPK(Date pstdDt, int trnsId, short seqNbr) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
        this.seqNbr = seqNbr;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvTmpsvcPK)) {
            return false;
        }
        InvTmpsvcPK other = (InvTmpsvcPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvTmpsvcPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + ", seqNbr=" + seqNbr + " ]";
    }
