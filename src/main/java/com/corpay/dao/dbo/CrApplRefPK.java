 ...
 */
@Embeddable
public class CrApplRefPK implements Serializable {
    ...
    public CrApplRefPK(String applNbr, short seqNbr) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CrApplRefPK)) {
            return false;
        }
        CrApplRefPK other = (CrApplRefPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.CrApplRefPK[ applNbr=" + applNbr + ", seqNbr=" + seqNbr + " ]";
    }
