 ...
 */
@Embeddable
public class PrdPfrdFlPK implements Serializable {
    ...
    public PrdPfrdFlPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdPfrdFlPK)) {
            return false;
        }
        PrdPfrdFlPK other = (PrdPfrdFlPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdPfrdFlPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
