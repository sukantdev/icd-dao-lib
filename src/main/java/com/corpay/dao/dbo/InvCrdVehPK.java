...
@Embeddable
public class InvCrdVehPK implements Serializable {
    ...
    public InvCrdVehPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvCrdVehPK)) {
            return false;
        }
        InvCrdVehPK other = (InvCrdVehPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvCrdVehPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
