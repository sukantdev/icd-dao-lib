...
@Embeddable
public class PrdEmpDrvOptnPK implements Serializable {
    ...
    public PrdEmpDrvOptnPK() {
    }

    public PrdEmpDrvOptnPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdEmpDrvOptnPK)) {
            return false;
        }
        PrdEmpDrvOptnPK other = (PrdEmpDrvOptnPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdEmpDrvOptnPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
