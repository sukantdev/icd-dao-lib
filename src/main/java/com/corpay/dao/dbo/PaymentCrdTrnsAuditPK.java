...
@Embeddable
public class PaymentCrdTrnsAuditPK implements Serializable {
    ...
    public PaymentCrdTrnsAuditPK() {
    }

    public PaymentCrdTrnsAuditPK(String trnsId, Date trnsTs) {
        this.trnsId = trnsId;
        this.trnsTs = trnsTs;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PaymentCrdTrnsAuditPK)) {
            return false;
        }
        PaymentCrdTrnsAuditPK other = (PaymentCrdTrnsAuditPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PaymentCrdTrnsAuditPK[ trnsId=" + trnsId + ", trnsTs=" + trnsTs + " ]";
    }
