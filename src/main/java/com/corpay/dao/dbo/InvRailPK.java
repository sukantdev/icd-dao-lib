...
@Embeddable
public class InvRailPK implements Serializable {
    ...
    public InvRailPK(Date pstdDt, int trnsId, short seqNo) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
        this.seqNo = seqNo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvRailPK)) {
            return false;
        }
        InvRailPK other = (InvRailPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvRailPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + ", seqNo=" + seqNo + " ]";
    }
