 ...
 */
@Embeddable
public class McSafePK implements Serializable {

    @Basic(optional = false)
    @Column(name = "SAFE_TRNS_ID")
    @Temporal(TemporalType.TIMESTAMP)
    private Date safeTrnsId;
    @Basic(optional = false)
    ...
    public McSafePK(Date safeTrnsId, short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
        this.safeTrnsId = safeTrnsId;
    ...
    public Date getSafeTrnsId() {
        return safeTrnsId;
    }

    public void setSafeTrnsId(Date safeTrnsId) {
        this.safeTrnsId = safeTrnsId;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (safeTrnsId != null ? safeTrnsId.hashCode() : 0);
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McSafePK)) {
            return false;
        }
        McSafePK other = (McSafePK) object;
        if ((this.safeTrnsId == null && other.safeTrnsId != null) || (this.safeTrnsId != null && !this.safeTrnsId.equals(other.safeTrnsId))) {
            return false;
        }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.McSafePK[ safeTrnsId=" + safeTrnsId + ", p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
