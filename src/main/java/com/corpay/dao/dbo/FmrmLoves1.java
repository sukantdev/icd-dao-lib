 ...
 */
@Entity
@Table(name = "FMRM_LOVES1", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "FmrmLoves1.findAll", query = "SELECT f FROM FmrmLoves1 f")})
public class FmrmLoves1 implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected FmrmLoves1PK fmrmLoves1PK;
    ...
    public FmrmLoves1(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.fmrmLoves1PK = new FmrmLoves1PK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public FmrmLoves1PK getFmrmLoves1PK() {
        return fmrmLoves1PK;
    }

    public void setFmrmLoves1PK(FmrmLoves1PK fmrmLoves1PK) {
        this.fmrmLoves1PK = fmrmLoves1PK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (fmrmLoves1PK != null ? fmrmLoves1PK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmLoves1)) {
            return false;
        }
        FmrmLoves1 other = (FmrmLoves1) object;
        if ((this.fmrmLoves1PK == null && other.fmrmLoves1PK != null) || (this.fmrmLoves1PK != null && !this.fmrmLoves1PK.equals(other.fmrmLoves1PK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmLoves1[ fmrmLoves1PK=" + fmrmLoves1PK + " ]";
    }
