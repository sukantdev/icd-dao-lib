...
@Embeddable
public class PrdPchsDtlPK implements Serializable {
    ...
    public PrdPchsDtlPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdPchsDtlPK)) {
            return false;
        }
        PrdPchsDtlPK other = (PrdPchsDtlPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdPchsDtlPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
