 ...
 */
@Embeddable
public class InvSumPK implements Serializable {
    ...
    public InvSumPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvSumPK)) {
            return false;
        }
        InvSumPK other = (InvSumPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvSumPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
