 ...
 */
@Embeddable
public class FnXtnFwLogPK implements Serializable {
    ...
    public FnXtnFwLogPK(String pan, Date utDt, int approvCd, Date localTs) {
        this.pan = pan;
        this.utDt = utDt;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FnXtnFwLogPK)) {
            return false;
        }
        FnXtnFwLogPK other = (FnXtnFwLogPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FnXtnFwLogPK[ pan=" + pan + ", utDt=" + utDt + ", approvCd=" + approvCd + ", localTs=" + localTs + " ]";
    }
