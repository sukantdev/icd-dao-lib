...
@Embeddable
public class PrpCanTax1PK implements Serializable {
    ...
    public PrpCanTax1PK(String canTaxPrvncCd, String canTaxPrdCd, Date canEfctvDt) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrpCanTax1PK)) {
            return false;
        }
        PrpCanTax1PK other = (PrpCanTax1PK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrpCanTax1PK[ canTaxPrvncCd=" + canTaxPrvncCd + ", canTaxPrdCd=" + canTaxPrdCd + ", canEfctvDt=" + canEfctvDt + " ]";
    }
