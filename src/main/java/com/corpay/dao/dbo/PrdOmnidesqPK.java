 ...
 */
@Embeddable
public class PrdOmnidesqPK implements Serializable {
    ...
    public PrdOmnidesqPK() {
    }

    public PrdOmnidesqPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdOmnidesqPK)) {
            return false;
        }
        PrdOmnidesqPK other = (PrdOmnidesqPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdOmnidesqPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
