 ...
 */
@Embeddable
public class InvCstPlusPK implements Serializable {
    ...
    public InvCstPlusPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvCstPlusPK)) {
            return false;
        }
        InvCstPlusPK other = (InvCstPlusPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvCstPlusPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
