 ...
 */
@Embeddable
public class PrdVsatPK implements Serializable {
    ...
    public PrdVsatPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdVsatPK)) {
            return false;
        }
        PrdVsatPK other = (PrdVsatPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdVsatPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
