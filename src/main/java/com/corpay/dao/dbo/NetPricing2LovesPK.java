 ...
 */
@Embeddable
public class NetPricing2LovesPK implements Serializable {
    ...
    public NetPricing2LovesPK() {
    }

    public NetPricing2LovesPK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing2LovesPK)) {
            return false;
        }
        NetPricing2LovesPK other = (NetPricing2LovesPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing2LovesPK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
