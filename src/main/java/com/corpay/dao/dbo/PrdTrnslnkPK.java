 ...
 */
@Embeddable
public class PrdTrnslnkPK implements Serializable {
    ...
    public PrdTrnslnkPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdTrnslnkPK)) {
            return false;
        }
        PrdTrnslnkPK other = (PrdTrnslnkPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdTrnslnkPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
