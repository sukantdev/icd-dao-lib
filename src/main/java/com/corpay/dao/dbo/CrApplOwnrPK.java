...
@Embeddable
public class CrApplOwnrPK implements Serializable {
    ...
    public CrApplOwnrPK(String applNbr, short seqNbr) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CrApplOwnrPK)) {
            return false;
        }
        CrApplOwnrPK other = (CrApplOwnrPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.CrApplOwnrPK[ applNbr=" + applNbr + ", seqNbr=" + seqNbr + " ]";
    }
