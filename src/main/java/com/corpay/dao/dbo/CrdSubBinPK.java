...
@Embeddable
public class CrdSubBinPK implements Serializable {
    ...
    public CrdSubBinPK(String crdTyp, String crdFrmt) {
        this.crdTyp = crdTyp;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CrdSubBinPK)) {
            return false;
        }
        CrdSubBinPK other = (CrdSubBinPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.CrdSubBinPK[ crdTyp=" + crdTyp + ", crdFrmt=" + crdFrmt + " ]";
    }
