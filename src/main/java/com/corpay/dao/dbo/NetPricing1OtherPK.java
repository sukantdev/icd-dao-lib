...
@Embeddable
public class NetPricing1OtherPK implements Serializable {
    ...
    public NetPricing1OtherPK() {
    }

    public NetPricing1OtherPK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing1OtherPK)) {
            return false;
        }
        NetPricing1OtherPK other = (NetPricing1OtherPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing1OtherPK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
