...
@Embeddable
public class MrchLocXrefPK implements Serializable {
    ...
    public MrchLocXrefPK() {
    }

    public MrchLocXrefPK(long acqInstIdCd, String acptId, String termId, Character xrefType) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MrchLocXrefPK)) {
            return false;
        }
        MrchLocXrefPK other = (MrchLocXrefPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.MrchLocXrefPK[ acqInstIdCd=" + acqInstIdCd + ", acptId=" + acptId + ", termId=" + termId + ", xrefType=" + xrefType + " ]";
    }
