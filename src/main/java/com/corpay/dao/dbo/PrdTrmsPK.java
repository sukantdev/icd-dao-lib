...
@Embeddable
public class PrdTrmsPK implements Serializable {
    ...
    public PrdTrmsPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdTrmsPK)) {
            return false;
        }
        PrdTrmsPK other = (PrdTrmsPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdTrmsPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
