...
@Embeddable
public class PrdOffHrsBlkngPK implements Serializable {
    ...
    public PrdOffHrsBlkngPK() {
    }

    public PrdOffHrsBlkngPK(String applNbr, String childTyp, short dy) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdOffHrsBlkngPK)) {
            return false;
        }
        PrdOffHrsBlkngPK other = (PrdOffHrsBlkngPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdOffHrsBlkngPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + ", dy=" + dy + " ]";
    }
