 ...
 */
@Entity
@Table(name = "NET_PRICING1_LOVES", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "NetPricing1Loves.findAll", query = "SELECT n FROM NetPricing1Loves n")})
public class NetPricing1Loves implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected NetPricing1LovesPK netPricing1LovesPK;
    ...
    public NetPricing1Loves(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.netPricing1LovesPK = new NetPricing1LovesPK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public NetPricing1LovesPK getNetPricing1LovesPK() {
        return netPricing1LovesPK;
    }

    public void setNetPricing1LovesPK(NetPricing1LovesPK netPricing1LovesPK) {
        this.netPricing1LovesPK = netPricing1LovesPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (netPricing1LovesPK != null ? netPricing1LovesPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing1Loves)) {
            return false;
        }
        NetPricing1Loves other = (NetPricing1Loves) object;
        if ((this.netPricing1LovesPK == null && other.netPricing1LovesPK != null) || (this.netPricing1LovesPK != null && !this.netPricing1LovesPK.equals(other.netPricing1LovesPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing1Loves[ netPricing1LovesPK=" + netPricing1LovesPK + " ]";
    }
