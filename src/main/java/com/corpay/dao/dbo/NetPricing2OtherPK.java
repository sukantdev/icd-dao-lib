 ...
 */
@Embeddable
public class NetPricing2OtherPK implements Serializable {
    ...
    public NetPricing2OtherPK() {
    }

    public NetPricing2OtherPK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing2OtherPK)) {
            return false;
        }
        NetPricing2OtherPK other = (NetPricing2OtherPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing2OtherPK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
