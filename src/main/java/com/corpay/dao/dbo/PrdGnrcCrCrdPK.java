 ...
 */
@Embeddable
public class PrdGnrcCrCrdPK implements Serializable {
    ...
    public PrdGnrcCrCrdPK() {
    }

    public PrdGnrcCrCrdPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdGnrcCrCrdPK)) {
            return false;
        }
        PrdGnrcCrCrdPK other = (PrdGnrcCrCrdPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdGnrcCrCrdPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
