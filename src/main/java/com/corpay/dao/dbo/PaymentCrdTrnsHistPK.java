...
@Embeddable
public class PaymentCrdTrnsHistPK implements Serializable {
    ...
    public PaymentCrdTrnsHistPK() {
    }

    public PaymentCrdTrnsHistPK(Date trnsTs, String trnsId) {
        this.trnsTs = trnsTs;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PaymentCrdTrnsHistPK)) {
            return false;
        }
        PaymentCrdTrnsHistPK other = (PaymentCrdTrnsHistPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PaymentCrdTrnsHistPK[ trnsTs=" + trnsTs + ", trnsId=" + trnsId + " ]";
    }
