 ...
 */
@Embeddable
public class VpCvTransXrefPK implements Serializable {
    ...
    public VpCvTransXrefPK() {
    }

    public VpCvTransXrefPK(String authPan, Date authUtDt, int authApprovCd, Date authLocalTs) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VpCvTransXrefPK)) {
            return false;
        }
        VpCvTransXrefPK other = (VpCvTransXrefPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.VpCvTransXrefPK[ authPan=" + authPan + ", authUtDt=" + authUtDt + ", authApprovCd=" + authApprovCd + ", authLocalTs=" + authLocalTs + " ]";
    }
