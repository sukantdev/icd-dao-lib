 ...
 */
@Entity
@Table(name = "PAYCODE", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "Paycode.findAll", query = "SELECT p FROM Paycode p")})
public class Paycode implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected PaycodePK paycodePK;
    ...
    public Paycode(String payLoc, String payUniqCd) {
        this.paycodePK = new PaycodePK(payLoc, payUniqCd);
    }

    public PaycodePK getPaycodePK() {
        return paycodePK;
    }

    public void setPaycodePK(PaycodePK paycodePK) {
        this.paycodePK = paycodePK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (paycodePK != null ? paycodePK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Paycode)) {
            return false;
        }
        Paycode other = (Paycode) object;
        if ((this.paycodePK == null && other.paycodePK != null) || (this.paycodePK != null && !this.paycodePK.equals(other.paycodePK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.Paycode[ paycodePK=" + paycodePK + " ]";
    }
