 ...
 */
@Entity
@Table(name = "NET_PRICING1_OTHER", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "NetPricing1Other.findAll", query = "SELECT n FROM NetPricing1Other n")})
public class NetPricing1Other implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected NetPricing1OtherPK netPricing1OtherPK;
    ...
    public NetPricing1Other(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.netPricing1OtherPK = new NetPricing1OtherPK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public NetPricing1OtherPK getNetPricing1OtherPK() {
        return netPricing1OtherPK;
    }

    public void setNetPricing1OtherPK(NetPricing1OtherPK netPricing1OtherPK) {
        this.netPricing1OtherPK = netPricing1OtherPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (netPricing1OtherPK != null ? netPricing1OtherPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing1Other)) {
            return false;
        }
        NetPricing1Other other = (NetPricing1Other) object;
        if ((this.netPricing1OtherPK == null && other.netPricing1OtherPK != null) || (this.netPricing1OtherPK != null && !this.netPricing1OtherPK.equals(other.netPricing1OtherPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing1Other[ netPricing1OtherPK=" + netPricing1OtherPK + " ]";
    }
