...
public class NetPricing1Pilot implements Serializable {
    ...
    @EmbeddedId
    protected NetPricing1PilotPK netPricing1PilotPK;
    ...
    public NetPricing1Pilot(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.netPricing1PilotPK = new NetPricing1PilotPK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public NetPricing1PilotPK getNetPricing1PilotPK() {
        return netPricing1PilotPK;
    }

    public void setNetPricing1PilotPK(NetPricing1PilotPK netPricing1PilotPK) {
        this.netPricing1PilotPK = netPricing1PilotPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (netPricing1PilotPK != null ? netPricing1PilotPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        NetPricing1Pilot other = (NetPricing1Pilot) object;
        if ((this.netPricing1PilotPK == null && other.netPricing1PilotPK != null) || (this.netPricing1PilotPK != null && !this.netPricing1PilotPK.equals(other.netPricing1PilotPK))) {
            return false;
        }
        return true;
    }
