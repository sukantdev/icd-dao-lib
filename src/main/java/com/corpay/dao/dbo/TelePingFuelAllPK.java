 ...
 */
@Embeddable
public class TelePingFuelAllPK implements Serializable {
    ...
    public TelePingFuelAllPK() {
    }

    public TelePingFuelAllPK(String custId, String unitNbr, Date cdnRecvTs) {
        this.custId = custId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TelePingFuelAllPK)) {
            return false;
        }
        TelePingFuelAllPK other = (TelePingFuelAllPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.TelePingFuelAllPK[ custId=" + custId + ", unitNbr=" + unitNbr + ", cdnRecvTs=" + cdnRecvTs + " ]";
    }
