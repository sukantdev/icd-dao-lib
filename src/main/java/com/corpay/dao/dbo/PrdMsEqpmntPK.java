 ...
 */
@Embeddable
public class PrdMsEqpmntPK implements Serializable {
    ...
    public PrdMsEqpmntPK() {
    }

    public PrdMsEqpmntPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdMsEqpmntPK)) {
            return false;
        }
        PrdMsEqpmntPK other = (PrdMsEqpmntPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdMsEqpmntPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
