 ...
 */
@Entity
@Table(name = "NET_PRICING2_OTHER", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "NetPricing2Other.findAll", query = "SELECT n FROM NetPricing2Other n")})
public class NetPricing2Other implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected NetPricing2OtherPK netPricing2OtherPK;
    ...
    public NetPricing2Other(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.netPricing2OtherPK = new NetPricing2OtherPK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public NetPricing2OtherPK getNetPricing2OtherPK() {
        return netPricing2OtherPK;
    }

    public void setNetPricing2OtherPK(NetPricing2OtherPK netPricing2OtherPK) {
        this.netPricing2OtherPK = netPricing2OtherPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (netPricing2OtherPK != null ? netPricing2OtherPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing2Other)) {
            return false;
        }
        NetPricing2Other other = (NetPricing2Other) object;
        if ((this.netPricing2OtherPK == null && other.netPricing2OtherPK != null) || (this.netPricing2OtherPK != null && !this.netPricing2OtherPK.equals(other.netPricing2OtherPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing2Other[ netPricing2OtherPK=" + netPricing2OtherPK + " ]";
    }
