...
@Embeddable
public class NetPricing1PilotPK implements Serializable {
    ...
    public NetPricing1PilotPK() {
    }

    public NetPricing1PilotPK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing1PilotPK)) {
            return false;
        }
        NetPricing1PilotPK other = (NetPricing1PilotPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing1PilotPK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
