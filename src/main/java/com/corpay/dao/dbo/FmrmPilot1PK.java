...
@Embeddable
public class FmrmPilot1PK implements Serializable {
    ...
    public FmrmPilot1PK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmPilot1PK)) {
            return false;
        }
        FmrmPilot1PK other = (FmrmPilot1PK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmPilot1PK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
