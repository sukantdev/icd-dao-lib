 ...
 */
@Entity
@Table(name = "FMRM_OTHER2", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "FmrmOther2.findAll", query = "SELECT f FROM FmrmOther2 f")})
public class FmrmOther2 implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected FmrmOther2PK fmrmOther2PK;
    ...
    public FmrmOther2(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.fmrmOther2PK = new FmrmOther2PK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public FmrmOther2PK getFmrmOther2PK() {
        return fmrmOther2PK;
    }

    public void setFmrmOther2PK(FmrmOther2PK fmrmOther2PK) {
        this.fmrmOther2PK = fmrmOther2PK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (fmrmOther2PK != null ? fmrmOther2PK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmOther2)) {
            return false;
        }
        FmrmOther2 other = (FmrmOther2) object;
        if ((this.fmrmOther2PK == null && other.fmrmOther2PK != null) || (this.fmrmOther2PK != null && !this.fmrmOther2PK.equals(other.fmrmOther2PK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmOther2[ fmrmOther2PK=" + fmrmOther2PK + " ]";
    }
