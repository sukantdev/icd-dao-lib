 ...
 */
@Embeddable
public class FmrmLoves1PK implements Serializable {
    ...
    public FmrmLoves1PK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmLoves1PK)) {
            return false;
        }
        FmrmLoves1PK other = (FmrmLoves1PK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmLoves1PK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
