...
@Embeddable
public class InvTrnsIndPK implements Serializable {
    ...
    public InvTrnsIndPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvTrnsIndPK)) {
            return false;
        }
        InvTrnsIndPK other = (InvTrnsIndPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvTrnsIndPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
