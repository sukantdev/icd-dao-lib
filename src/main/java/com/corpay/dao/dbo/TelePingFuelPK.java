 ...
 */
@Embeddable
public class TelePingFuelPK implements Serializable {
    ...
    public TelePingFuelPK() {
    }

    public TelePingFuelPK(String custId, String unitNbr, Date cdnRecvTs) {
        this.custId = custId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TelePingFuelPK)) {
            return false;
        }
        TelePingFuelPK other = (TelePingFuelPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.TelePingFuelPK[ custId=" + custId + ", unitNbr=" + unitNbr + ", cdnRecvTs=" + cdnRecvTs + " ]";
    }
