 ...
 */
@Entity
@Table(name = "FMRM_PILOT2", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "FmrmPilot2.findAll", query = "SELECT f FROM FmrmPilot2 f")})
public class FmrmPilot2 implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected FmrmPilot2PK fmrmPilot2PK;
    ...
    public FmrmPilot2(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.fmrmPilot2PK = new FmrmPilot2PK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public FmrmPilot2PK getFmrmPilot2PK() {
        return fmrmPilot2PK;
    }

    public void setFmrmPilot2PK(FmrmPilot2PK fmrmPilot2PK) {
        this.fmrmPilot2PK = fmrmPilot2PK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (fmrmPilot2PK != null ? fmrmPilot2PK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmPilot2)) {
            return false;
        }
        FmrmPilot2 other = (FmrmPilot2) object;
        if ((this.fmrmPilot2PK == null && other.fmrmPilot2PK != null) || (this.fmrmPilot2PK != null && !this.fmrmPilot2PK.equals(other.fmrmPilot2PK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmPilot2[ fmrmPilot2PK=" + fmrmPilot2PK + " ]";
    }
