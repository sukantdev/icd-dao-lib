 ...
 */
@Embeddable
public class PrdPrmtsPK implements Serializable {
    ...
    public PrdPrmtsPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdPrmtsPK)) {
            return false;
        }
        PrdPrmtsPK other = (PrdPrmtsPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdPrmtsPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
