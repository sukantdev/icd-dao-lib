 ...
 */
@Embeddable
public class PrdSmrtlckCrdlckPK implements Serializable {
    ...
    public PrdSmrtlckCrdlckPK() {
    }

    public PrdSmrtlckCrdlckPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdSmrtlckCrdlckPK)) {
            return false;
        }
        PrdSmrtlckCrdlckPK other = (PrdSmrtlckCrdlckPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdSmrtlckCrdlckPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
