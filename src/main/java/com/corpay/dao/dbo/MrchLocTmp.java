 ...
 */
@Entity
@Table(name = "MRCH_LOC_TMP", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "MrchLocTmp.findAll", query = "SELECT m FROM MrchLocTmp m")})
public class MrchLocTmp implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MrchLocTmp)) {
            return false;
        }
        MrchLocTmp other = (MrchLocTmp) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.MrchLocTmp[ locId=" + locId + " ]";
    }
