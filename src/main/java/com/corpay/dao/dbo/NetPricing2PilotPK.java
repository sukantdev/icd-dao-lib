...
@Embeddable
public class NetPricing2PilotPK implements Serializable {
    ...
    public NetPricing2PilotPK() {
    }

    public NetPricing2PilotPK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing2PilotPK)) {
            return false;
        }
        NetPricing2PilotPK other = (NetPricing2PilotPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing2PilotPK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
