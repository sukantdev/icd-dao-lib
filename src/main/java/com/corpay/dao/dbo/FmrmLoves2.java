 ...
 */
@Entity
@Table(name = "FMRM_LOVES2", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "FmrmLoves2.findAll", query = "SELECT f FROM FmrmLoves2 f")})
public class FmrmLoves2 implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected FmrmLoves2PK fmrmLoves2PK;
    ...
    public FmrmLoves2(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.fmrmLoves2PK = new FmrmLoves2PK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public FmrmLoves2PK getFmrmLoves2PK() {
        return fmrmLoves2PK;
    }

    public void setFmrmLoves2PK(FmrmLoves2PK fmrmLoves2PK) {
        this.fmrmLoves2PK = fmrmLoves2PK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (fmrmLoves2PK != null ? fmrmLoves2PK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmLoves2)) {
            return false;
        }
        FmrmLoves2 other = (FmrmLoves2) object;
        if ((this.fmrmLoves2PK == null && other.fmrmLoves2PK != null) || (this.fmrmLoves2PK != null && !this.fmrmLoves2PK.equals(other.fmrmLoves2PK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmLoves2[ fmrmLoves2PK=" + fmrmLoves2PK + " ]";
    }
