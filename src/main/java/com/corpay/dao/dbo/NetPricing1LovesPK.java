...
@Embeddable
public class NetPricing1LovesPK implements Serializable {
    ...
    public NetPricing1LovesPK() {
    }

    public NetPricing1LovesPK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing1LovesPK)) {
            return false;
        }
        NetPricing1LovesPK other = (NetPricing1LovesPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing1LovesPK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
