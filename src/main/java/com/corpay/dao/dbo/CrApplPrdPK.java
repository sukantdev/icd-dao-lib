...
@Embeddable
public class CrApplPrdPK implements Serializable {
    ...
    public CrApplPrdPK(String applNbr, short seqNbr) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CrApplPrdPK)) {
            return false;
        }
        CrApplPrdPK other = (CrApplPrdPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.CrApplPrdPK[ applNbr=" + applNbr + ", seqNbr=" + seqNbr + " ]";
    }
