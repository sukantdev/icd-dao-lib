...
@Embeddable
public class PrdPilotCarPK implements Serializable {
    ...
    public PrdPilotCarPK() {
    }

    public PrdPilotCarPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdPilotCarPK)) {
            return false;
        }
        PrdPilotCarPK other = (PrdPilotCarPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdPilotCarPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
