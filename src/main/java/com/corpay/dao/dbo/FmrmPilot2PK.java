 ...
 */
@Embeddable
public class FmrmPilot2PK implements Serializable {
    ...
    public FmrmPilot2PK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmPilot2PK)) {
            return false;
        }
        FmrmPilot2PK other = (FmrmPilot2PK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmPilot2PK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
