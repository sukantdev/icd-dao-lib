...
@Embeddable
public class PrdCrdBlngPK implements Serializable {
    ...
    public PrdCrdBlngPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdCrdBlngPK)) {
            return false;
        }
        PrdCrdBlngPK other = (PrdCrdBlngPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdCrdBlngPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
