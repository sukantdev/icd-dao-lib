...
@Embeddable
public class InvTrnspDtlPK implements Serializable {
    ...
    public InvTrnspDtlPK() {
    }

    public InvTrnspDtlPK(Date pstdDt, int trnsId, int seqNbr) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
        this.seqNbr = seqNbr;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvTrnspDtlPK)) {
            return false;
        }
        InvTrnspDtlPK other = (InvTrnspDtlPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvTrnspDtlPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + ", seqNbr=" + seqNbr + " ]";
    }
