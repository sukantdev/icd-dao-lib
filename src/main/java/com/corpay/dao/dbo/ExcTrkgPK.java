 ...
 */
@Embeddable
public class ExcTrkgPK implements Serializable {
    ...
    public ExcTrkgPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ExcTrkgPK)) {
            return false;
        }
        ExcTrkgPK other = (ExcTrkgPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.ExcTrkgPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
