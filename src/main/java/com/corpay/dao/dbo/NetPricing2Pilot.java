 ...
 */
@Entity
@Table(name = "NET_PRICING2_PILOT", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "NetPricing2Pilot.findAll", query = "SELECT n FROM NetPricing2Pilot n")})
public class NetPricing2Pilot implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected NetPricing2PilotPK netPricing2PilotPK;
    ...
    public NetPricing2Pilot(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
        this.netPricing2PilotPK = new NetPricing2PilotPK(acctNbr, locCd, custId, prdCd, effctvDtTs, pfidCd, netPrdGrp, fndngRltnshpCd);
    }

    public NetPricing2PilotPK getNetPricing2PilotPK() {
        return netPricing2PilotPK;
    }

    public void setNetPricing2PilotPK(NetPricing2PilotPK netPricing2PilotPK) {
        this.netPricing2PilotPK = netPricing2PilotPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (netPricing2PilotPK != null ? netPricing2PilotPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NetPricing2Pilot)) {
            return false;
        }
        NetPricing2Pilot other = (NetPricing2Pilot) object;
        if ((this.netPricing2PilotPK == null && other.netPricing2PilotPK != null) || (this.netPricing2PilotPK != null && !this.netPricing2PilotPK.equals(other.netPricing2PilotPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.NetPricing2Pilot[ netPricing2PilotPK=" + netPricing2PilotPK + " ]";
    }
