...
@Embeddable
public class FmrmOther1PK implements Serializable {
    ...
    public FmrmOther1PK(String acctNbr, String locCd, String custId, String prdCd, Date effctvDtTs, String pfidCd, String netPrdGrp, Character fndngRltnshpCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FmrmOther1PK)) {
            return false;
        }
        FmrmOther1PK other = (FmrmOther1PK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.FmrmOther1PK[ acctNbr=" + acctNbr + ", locCd=" + locCd + ", custId=" + custId + ", prdCd=" + prdCd + ", effctvDtTs=" + effctvDtTs + ", pfidCd=" + pfidCd + ", netPrdGrp=" + netPrdGrp + ", fndngRltnshpCd=" + fndngRltnshpCd + " ]";
    }
