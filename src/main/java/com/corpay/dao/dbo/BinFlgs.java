 ...
 */
@Entity
@Table(name = "BIN_FLGS", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "BinFlgs.findAll", query = "SELECT b FROM BinFlgs b")})
public class BinFlgs implements Serializable {
    ...
    private Integer bin;
    @Basic(optional = false)
    @Column(name = "BIN_FLGS")
    private String binFlgs;
    @Basic(optional = false)
    @Column(name = "BIN_STAT")
    private Character binStat;
    @Basic(optional = false)
    @Column(name = "CRT_TS")
    ...
    @Basic(optional = false)
    @Column(name = "CB_VIP_FLG")
    private Character cbVipFlg;
    @Basic(optional = false)
    ...
    public String getBinFlgs() {
        return binFlgs;
    }

    public void setBinFlgs(String binFlgs) {
        this.binFlgs = binFlgs;
    }

    public Character getBinStat() {
        return binStat;
    }

    public void setBinStat(Character binStat) {
        this.binStat = binStat;
    }
    ...
    public Character getCbVipFlg() {
        return cbVipFlg;
    }

    public void setCbVipFlg(Character cbVipFlg) {
        this.cbVipFlg = cbVipFlg;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BinFlgs)) {
            return false;
        }
        BinFlgs other = (BinFlgs) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.BinFlgs[ bin=" + bin + " ]";
    }
