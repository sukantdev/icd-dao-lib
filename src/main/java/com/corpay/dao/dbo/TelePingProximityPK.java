 ...
 */
@Embeddable
public class TelePingProximityPK implements Serializable {
    ...
    public TelePingProximityPK() {
    }

    public TelePingProximityPK(String custId, String unitNbr, Date cdnRecvTs) {
        this.custId = custId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TelePingProximityPK)) {
            return false;
        }
        TelePingProximityPK other = (TelePingProximityPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.TelePingProximityPK[ custId=" + custId + ", unitNbr=" + unitNbr + ", cdnRecvTs=" + cdnRecvTs + " ]";
    }
