...
@Embeddable
public class Dx38AddInfoPK implements Serializable {
    ...
    public Dx38AddInfoPK() {
    }

    public Dx38AddInfoPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Dx38AddInfoPK)) {
            return false;
        }
        Dx38AddInfoPK other = (Dx38AddInfoPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.Dx38AddInfoPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
