 ...
 */
@Entity
@Table(name = "WD_BNK_TRNS", catalog = "", schema = "DBO")
@NamedQueries({
    @NamedQuery(name = "WdBnkTrns.findAll", query = "SELECT w FROM WdBnkTrns w")})
public class WdBnkTrns implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected WdBnkTrnsPK wdBnkTrnsPK;
    ...
    public WdBnkTrns(int btPmtNbr, Date btTrnsDt) {
        this.wdBnkTrnsPK = new WdBnkTrnsPK(btPmtNbr, btTrnsDt);
    }

    public WdBnkTrnsPK getWdBnkTrnsPK() {
        return wdBnkTrnsPK;
    }

    public void setWdBnkTrnsPK(WdBnkTrnsPK wdBnkTrnsPK) {
        this.wdBnkTrnsPK = wdBnkTrnsPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (wdBnkTrnsPK != null ? wdBnkTrnsPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WdBnkTrns)) {
            return false;
        }
        WdBnkTrns other = (WdBnkTrns) object;
        if ((this.wdBnkTrnsPK == null && other.wdBnkTrnsPK != null) || (this.wdBnkTrnsPK != null && !this.wdBnkTrnsPK.equals(other.wdBnkTrnsPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.dbo.WdBnkTrns[ wdBnkTrnsPK=" + wdBnkTrnsPK + " ]";
    }
