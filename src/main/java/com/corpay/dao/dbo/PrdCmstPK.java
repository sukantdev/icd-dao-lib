 ...
 */
@Embeddable
public class PrdCmstPK implements Serializable {
    ...
    public PrdCmstPK(String applNbr, String childTyp) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrdCmstPK)) {
            return false;
        }
        PrdCmstPK other = (PrdCmstPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.PrdCmstPK[ applNbr=" + applNbr + ", childTyp=" + childTyp + " ]";
    }
