...
@Embeddable
public class InvArlnPK implements Serializable {
    ...
    public InvArlnPK(Date pstdDt, int trnsId) {
        this.pstdDt = pstdDt;
        this.trnsId = trnsId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InvArlnPK)) {
            return false;
        }
        InvArlnPK other = (InvArlnPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.InvArlnPK[ pstdDt=" + pstdDt + ", trnsId=" + trnsId + " ]";
    }
