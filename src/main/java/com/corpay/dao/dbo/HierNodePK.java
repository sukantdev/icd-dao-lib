...
@Embeddable
public class HierNodePK implements Serializable {
    ...
    public HierNodePK(String hierId, String nodeId) {
        this.hierId = hierId;
        this.nodeId = nodeId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HierNodePK)) {
            return false;
        }
        HierNodePK other = (HierNodePK) object;
    ...
    public String toString() {
        return "com.corpay.dao.dbo.HierNodePK[ hierId=" + hierId + ", nodeId=" + nodeId + " ]";
    }
