...
@Embeddable
public class ProdLimitsUse9PK implements Serializable {
    ...
    public ProdLimitsUse9PK() {
    }

    public ProdLimitsUse9PK(String prduCustId, Character prduCcType, long prduProfileId, int prodcId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProdLimitsUse9PK)) {
            return false;
        }
        ProdLimitsUse9PK other = (ProdLimitsUse9PK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.ProdLimitsUse9PK[ prduCustId=" + prduCustId + ", prduCcType=" + prduCcType + ", prduProfileId=" + prduProfileId + ", prodcId=" + prodcId + " ]";
    }
