 ...
 */
@Embeddable
public class McFirstPresSupbPK implements Serializable {
    ...
    public McFirstPresSupbPK() {
    }

    public McFirstPresSupbPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McFirstPresSupbPK)) {
            return false;
        }
        McFirstPresSupbPK other = (McFirstPresSupbPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McFirstPresSupbPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
