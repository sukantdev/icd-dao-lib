...
@Embeddable
public class McSuplmDataPK implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "SDATA_TYP")
    private Character sdataTyp;

    public McSuplmDataPK() {
    }

    public McSuplmDataPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo, short occInd, Character sdataTyp) {
    ...
    public Character getSdataTyp() {
        return sdataTyp;
    }

    public void setSdataTyp(Character sdataTyp) {
        this.sdataTyp = sdataTyp;
    }
    ...
    public int hashCode() {
        ...
        hash += (int) d71MsgNo;
        hash += (int) occInd;
        hash += (sdataTyp != null ? sdataTyp.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McSuplmDataPK)) {
            return false;
        }
        McSuplmDataPK other = (McSuplmDataPK) object;
        ...
        if ((this.sdataTyp == null && other.sdataTyp != null) || (this.sdataTyp != null && !this.sdataTyp.equals(other.sdataTyp))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McSuplmDataPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + ", occInd=" + occInd + ", sdataTyp=" + sdataTyp + " ]";
    }
