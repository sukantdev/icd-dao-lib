...
public class McAddEiPty implements Serializable {
    ...
    @EmbeddedId
    protected McAddEiPtyPK mcAddEiPtyPK;
    ...
    @Basic(optional = false)
    @Column(name = "P590_PTY_ID")
    private String p590PtyId;
    @Basic(optional = false)
    @Column(name = "P601_PTY_NAT_OF_FL")
    private Character p601PtyNatOfFl;
    @Basic(optional = false)
    ...
    public McAddEiPty(McAddEiPtyPK mcAddEiPtyPK) {
        this.mcAddEiPtyPK = mcAddEiPtyPK;
    }

    public McAddEiPty(McAddEiPtyPK mcAddEiPtyPK, short msgTyId, String bitMapPri, String d1BitMapSec, short d24FuncCd, long d32AcqInstIdCd, long d33FwdngInstCd, short p191OrMsgFmt, short p501s1UsageCd, short p501s2IndstyRec, short p501s3OccInd, int p501s4MsgNo, String p590PtyId, Character p601PtyNatOfFl, Character d63s1LfcycSpInd, String d63s2TraceId, String d63s3ValidnCd, String d63s4LfcyctrSeq, String d63s5LfcyctrTot, long d93TrDestInst, long d94TrOrgInst, long d100RecvInstId, String d48AddtlDat, String d62AddtlData2, String d123AddtlDat3, String d124AddtlDat4, String d125AddtlDat5) {
        this.mcAddEiPtyPK = mcAddEiPtyPK;
        ...
        this.p590PtyId = p590PtyId;
        this.p601PtyNatOfFl = p601PtyNatOfFl;
    ...
    public McAddEiPty(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
        this.mcAddEiPtyPK = new McAddEiPtyPK(p105s1FileTy, p105s2FileRDt, p105s3ProcId, p105s4FileSeqNo, d71MsgNo);
    }

    public McAddEiPtyPK getMcAddEiPtyPK() {
        return mcAddEiPtyPK;
    }

    public void setMcAddEiPtyPK(McAddEiPtyPK mcAddEiPtyPK) {
        this.mcAddEiPtyPK = mcAddEiPtyPK;
    }
    ...
    public String getP590PtyId() {
        return p590PtyId;
    }

    public void setP590PtyId(String p590PtyId) {
        this.p590PtyId = p590PtyId;
    }

    public Character getP601PtyNatOfFl() {
        return p601PtyNatOfFl;
    }

    public void setP601PtyNatOfFl(Character p601PtyNatOfFl) {
        this.p601PtyNatOfFl = p601PtyNatOfFl;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (mcAddEiPtyPK != null ? mcAddEiPtyPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        McAddEiPty other = (McAddEiPty) object;
        if ((this.mcAddEiPtyPK == null && other.mcAddEiPtyPK != null) || (this.mcAddEiPtyPK != null && !this.mcAddEiPtyPK.equals(other.mcAddEiPtyPK))) {
            return false;
        }
        return true;
    }
