...
@Embeddable
public class McAddEiTrnsPK implements Serializable {
    ...
    public McAddEiTrnsPK() {
    }

    public McAddEiTrnsPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McAddEiTrnsPK)) {
            return false;
        }
        McAddEiTrnsPK other = (McAddEiTrnsPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McAddEiTrnsPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
