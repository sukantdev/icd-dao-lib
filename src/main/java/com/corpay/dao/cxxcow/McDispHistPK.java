...
@Embeddable
public class McDispHistPK implements Serializable {
    ...
    public McDispHistPK(String d2PriAccntNo, int d12s1LocalTrDt, BigDecimal d30s1TrOrigAmt, short d31s1IcRtDsgtr, int d31s2AcquirBin, short d31s3JulPrcDt, long d31s4AcqSeqNo, short d31s5CheckDigit, String d38ApprvlCd, int u0002AddedDt, int u0003AddedTm) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McDispHistPK)) {
            return false;
        }
        McDispHistPK other = (McDispHistPK) object;
