...
@Embeddable
public class McAuthFuelInfoPK implements Serializable {
    ...
    public McAuthFuelInfoPK() {
    }

    public McAuthFuelInfoPK(String authPan, Date authUtDt, int authApprovCd, Date authLocalTs, short prdSeqNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McAuthFuelInfoPK)) {
            return false;
        }
        McAuthFuelInfoPK other = (McAuthFuelInfoPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McAuthFuelInfoPK[ authPan=" + authPan + ", authUtDt=" + authUtDt + ", authApprovCd=" + authApprovCd + ", authLocalTs=" + authLocalTs + ", prdSeqNo=" + prdSeqNo + " ]";
    }
