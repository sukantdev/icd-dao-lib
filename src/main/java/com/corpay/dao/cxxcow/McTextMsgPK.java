 ...
 */
@Embeddable
public class McTextMsgPK implements Serializable {
    ...
    public McTextMsgPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McTextMsgPK)) {
            return false;
        }
        McTextMsgPK other = (McTextMsgPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McTextMsgPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
