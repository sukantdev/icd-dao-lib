...
public class McAddShpng implements Serializable {
    ...
    @EmbeddedId
    protected McAddShpngPK mcAddShpngPK;
    ...
    @Basic(optional = false)
    @Column(name = "P735_SVC_DESC_CD")
    private String p735SvcDescCd;
    @Basic(optional = false)
    @Column(name = "P736_TRACK_NR")
    private String p736TrackNr;
    @Basic(optional = false)
    @Column(name = "P737S1_SHPNET_AMT")
    private BigDecimal p737s1ShpnetAmt;
    @Basic(optional = false)
    @Column(name = "P737S2_SHPNET_AMTE")
    private short p737s2ShpnetAmte;
    @Basic(optional = false)
    @Column(name = "P737S3_SHPNET_AMTS")
    private Character p737s3ShpnetAmts;
    @Basic(optional = false)
    @Column(name = "P738S1_INCT_AMT")
    private BigDecimal p738s1InctAmt;
    @Basic(optional = false)
    @Column(name = "P738S2_INCT_AMT_EX")
    private short p738s2InctAmtEx;
    @Basic(optional = false)
    @Column(name = "P738S3_INCT_AMT_SG")
    private Character p738s3InctAmtSg;
    @Basic(optional = false)
    @Column(name = "P739_PKUP_DT")
    private int p739PkupDt;
    @Basic(optional = false)
    @Column(name = "P740_DLVR_DT")
    private int p740DlvrDt;
    @Basic(optional = false)
    @Column(name = "P741_NR_PKG")
    private int p741NrPkg;
    @Basic(optional = false)
    @Column(name = "P742_PCKG_WT")
    private String p742PckgWt;
    @Basic(optional = false)
    @Column(name = "P743_UNIT_MSR")
    private String p743UnitMsr;
    @Basic(optional = false)
    ...
    @Basic(optional = false)
    @Column(name = "A737S1_SHPNET_AMT")
    private BigDecimal a737s1ShpnetAmt;

    public McAddShpng() {
    }

    public McAddShpng(McAddShpngPK mcAddShpngPK) {
        this.mcAddShpngPK = mcAddShpngPK;
    }

    public McAddShpng(McAddShpngPK mcAddShpngPK, short msgTyId, String bitMapPri, String d1BitMapSec, short d24FuncCd, long d32AcqInstIdCd, long d33FwdngInstCd, short p191OrMsgFmt, short p501s1UsageCd, short p501s2IndstyRec, short p501s3OccInd, int p501s4MsgNo, String p508CustCd, BigDecimal p597s1TtxAmt, short p597s2TtxAmtExp, Character p597s3TtxAmtSig, String p598TaxCltnInd, String p679Commodity, Character p686TaxExempt, String p735SvcDescCd, String p736TrackNr, BigDecimal p737s1ShpnetAmt, short p737s2ShpnetAmte, Character p737s3ShpnetAmts, BigDecimal p738s1InctAmt, short p738s2InctAmtEx, Character p738s3InctAmtSg, int p739PkupDt, int p740DlvrDt, int p741NrPkg, String p742PckgWt, String p743UnitMsr, String taxAmtTs, Character taxAmt682Ind, Character taxAmt683Ind, Character taxAmt684Ind, Character taxAmt751Ind, Character taxAmt752Ind, Character taxAmt753Ind, Character d63s1LfcycSpInd, String d63s2TraceId, String d63s3ValidnCd, String d63s4LfcyctrSeq, String d63s5LfcyctrTot, long d93TrDestInst, long d94TrOrgInst, long d100RecvInstId, String d48AddtlDat, String d62AddtlData2, String d123AddtlDat3, String d124AddtlDat4, String d125AddtlDat5, BigDecimal a597s1TtxAmt, BigDecimal a737s1ShpnetAmt) {
        this.mcAddShpngPK = mcAddShpngPK;
        ...
        this.p735SvcDescCd = p735SvcDescCd;
        this.p736TrackNr = p736TrackNr;
        this.p737s1ShpnetAmt = p737s1ShpnetAmt;
        this.p737s2ShpnetAmte = p737s2ShpnetAmte;
        this.p737s3ShpnetAmts = p737s3ShpnetAmts;
        this.p738s1InctAmt = p738s1InctAmt;
        this.p738s2InctAmtEx = p738s2InctAmtEx;
        this.p738s3InctAmtSg = p738s3InctAmtSg;
        this.p739PkupDt = p739PkupDt;
        this.p740DlvrDt = p740DlvrDt;
        this.p741NrPkg = p741NrPkg;
        this.p742PckgWt = p742PckgWt;
        this.p743UnitMsr = p743UnitMsr;
        ...
        this.a737s1ShpnetAmt = a737s1ShpnetAmt;
    }

    public McAddShpng(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
        this.mcAddShpngPK = new McAddShpngPK(p105s1FileTy, p105s2FileRDt, p105s3ProcId, p105s4FileSeqNo, d71MsgNo);
    }

    public McAddShpngPK getMcAddShpngPK() {
        return mcAddShpngPK;
    }

    public void setMcAddShpngPK(McAddShpngPK mcAddShpngPK) {
        this.mcAddShpngPK = mcAddShpngPK;
    }
    ...
    public String getP598TaxCltnInd() {
        return p598TaxCltnInd;
    }

    public void setP598TaxCltnInd(String p598TaxCltnInd) {
        this.p598TaxCltnInd = p598TaxCltnInd;
    }
    ...
    public String getP735SvcDescCd() {
        return p735SvcDescCd;
    }

    public void setP735SvcDescCd(String p735SvcDescCd) {
        this.p735SvcDescCd = p735SvcDescCd;
    }

    public String getP736TrackNr() {
        return p736TrackNr;
    }

    public void setP736TrackNr(String p736TrackNr) {
        this.p736TrackNr = p736TrackNr;
    }

    public BigDecimal getP737s1ShpnetAmt() {
        return p737s1ShpnetAmt;
    }

    public void setP737s1ShpnetAmt(BigDecimal p737s1ShpnetAmt) {
        this.p737s1ShpnetAmt = p737s1ShpnetAmt;
    }

    public short getP737s2ShpnetAmte() {
        return p737s2ShpnetAmte;
    }

    public void setP737s2ShpnetAmte(short p737s2ShpnetAmte) {
        this.p737s2ShpnetAmte = p737s2ShpnetAmte;
    }

    public Character getP737s3ShpnetAmts() {
        return p737s3ShpnetAmts;
    }

    public void setP737s3ShpnetAmts(Character p737s3ShpnetAmts) {
        this.p737s3ShpnetAmts = p737s3ShpnetAmts;
    }

    public BigDecimal getP738s1InctAmt() {
        return p738s1InctAmt;
    }

    public void setP738s1InctAmt(BigDecimal p738s1InctAmt) {
        this.p738s1InctAmt = p738s1InctAmt;
    }

    public short getP738s2InctAmtEx() {
        return p738s2InctAmtEx;
    }

    public void setP738s2InctAmtEx(short p738s2InctAmtEx) {
        this.p738s2InctAmtEx = p738s2InctAmtEx;
    }

    public Character getP738s3InctAmtSg() {
        return p738s3InctAmtSg;
    }

    public void setP738s3InctAmtSg(Character p738s3InctAmtSg) {
        this.p738s3InctAmtSg = p738s3InctAmtSg;
    }

    public int getP739PkupDt() {
        return p739PkupDt;
    }

    public void setP739PkupDt(int p739PkupDt) {
        this.p739PkupDt = p739PkupDt;
    }

    public int getP740DlvrDt() {
        return p740DlvrDt;
    }

    public void setP740DlvrDt(int p740DlvrDt) {
        this.p740DlvrDt = p740DlvrDt;
    }

    public int getP741NrPkg() {
        return p741NrPkg;
    }

    public void setP741NrPkg(int p741NrPkg) {
        this.p741NrPkg = p741NrPkg;
    }

    public String getP742PckgWt() {
        return p742PckgWt;
    }

    public void setP742PckgWt(String p742PckgWt) {
        this.p742PckgWt = p742PckgWt;
    }

    public String getP743UnitMsr() {
        return p743UnitMsr;
    }

    public void setP743UnitMsr(String p743UnitMsr) {
        this.p743UnitMsr = p743UnitMsr;
    }
    ...
    public BigDecimal getA737s1ShpnetAmt() {
        return a737s1ShpnetAmt;
    }

    public void setA737s1ShpnetAmt(BigDecimal a737s1ShpnetAmt) {
        this.a737s1ShpnetAmt = a737s1ShpnetAmt;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (mcAddShpngPK != null ? mcAddShpngPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        McAddShpng other = (McAddShpng) object;
        if ((this.mcAddShpngPK == null && other.mcAddShpngPK != null) || (this.mcAddShpngPK != null && !this.mcAddShpngPK.equals(other.mcAddShpngPK))) {
            return false;
        }
        return true;
    }
