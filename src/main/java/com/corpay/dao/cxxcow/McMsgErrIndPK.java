 ...
 */
@Embeddable
public class McMsgErrIndPK implements Serializable {
    ...
    public McMsgErrIndPK() {
    }

    public McMsgErrIndPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo, short occInd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McMsgErrIndPK)) {
            return false;
        }
        McMsgErrIndPK other = (McMsgErrIndPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McMsgErrIndPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + ", occInd=" + occInd + " ]";
    }
