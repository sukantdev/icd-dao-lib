...
@Embeddable
public class McEvntDtlPK implements Serializable {
    ...
    private Character evntTyp;

    public McEvntDtlPK() {
    }

    public McEvntDtlPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo, short occInd, Character evntTyp) {
    ...
    public Character getEvntTyp() {
        return evntTyp;
    }

    public void setEvntTyp(Character evntTyp) {
        this.evntTyp = evntTyp;
    }
    ...
    public int hashCode() {
        ...
        hash += (int) d71MsgNo;
        hash += (int) occInd;
        hash += (evntTyp != null ? evntTyp.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McEvntDtlPK)) {
            return false;
        }
        McEvntDtlPK other = (McEvntDtlPK) object;
        ...
        if ((this.evntTyp == null && other.evntTyp != null) || (this.evntTyp != null && !this.evntTyp.equals(other.evntTyp))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McEvntDtlPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + ", occInd=" + occInd + ", evntTyp=" + evntTyp + " ]";
    }
