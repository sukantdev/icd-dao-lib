...
@Embeddable
public class McAddTempSvcPK implements Serializable {
    ...
    public McAddTempSvcPK() {
    }

    public McAddTempSvcPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McAddTempSvcPK)) {
            return false;
        }
        McAddTempSvcPK other = (McAddTempSvcPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McAddTempSvcPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
