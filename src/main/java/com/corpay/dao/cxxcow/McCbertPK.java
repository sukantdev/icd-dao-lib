 ...
 */
@Embeddable
public class McCbertPK implements Serializable {
    ...
    public McCbertPK(String d2PriAccntNo, int d12s1LocalTrDt, BigDecimal d30s1TrOrigAmt, short d31s1IcRtDsgtr, int d31s2AcquirBin, short d31s3JulPrcDt, long d31s4AcqSeqNo, short d31s5CheckDigit, String d38ApprvlCd, int d71MsgNo, short u0000RecordType) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McCbertPK)) {
            return false;
        }
        McCbertPK other = (McCbertPK) object;
        ...
        if (this.u0000RecordType != other.u0000RecordType) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McCbertPK[ d2PriAccntNo=" + d2PriAccntNo + ", d12s1LocalTrDt=" + d12s1LocalTrDt + ", d30s1TrOrigAmt=" + d30s1TrOrigAmt + ", d31s1IcRtDsgtr=" + d31s1IcRtDsgtr + ", d31s2AcquirBin=" + d31s2AcquirBin + ", d31s3JulPrcDt=" + d31s3JulPrcDt + ", d31s4AcqSeqNo=" + d31s4AcqSeqNo + ", d31s5CheckDigit=" + d31s5CheckDigit + ", d38ApprvlCd=" + d38ApprvlCd + ", d71MsgNo=" + d71MsgNo + ", u0000RecordType=" + u0000RecordType + " ]";
    }
