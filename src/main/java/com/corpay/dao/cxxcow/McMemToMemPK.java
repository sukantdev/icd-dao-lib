...
@Embeddable
public class McMemToMemPK implements Serializable {
    ...
    public McMemToMemPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo, short occInd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McMemToMemPK)) {
            return false;
        }
        McMemToMemPK other = (McMemToMemPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McMemToMemPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + ", occInd=" + occInd + " ]";
    }
