 ...
 */
@Embeddable
public class McAddHealthcarePK implements Serializable {
    ...
    public McAddHealthcarePK() {
    }

    public McAddHealthcarePK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int p501s4MsgNo, short p501s3OccInd, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McAddHealthcarePK)) {
            return false;
        }
        McAddHealthcarePK other = (McAddHealthcarePK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McAddHealthcarePK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", p501s4MsgNo=" + p501s4MsgNo + ", p501s3OccInd=" + p501s3OccInd + ", d71MsgNo=" + d71MsgNo + " ]";
    }
