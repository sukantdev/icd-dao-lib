 ...
 */
@Embeddable
public class McSecondPresPK implements Serializable {
    ...
    public McSecondPresPK() {
    }

    public McSecondPresPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McSecondPresPK)) {
            return false;
        }
        McSecondPresPK other = (McSecondPresPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McSecondPresPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
