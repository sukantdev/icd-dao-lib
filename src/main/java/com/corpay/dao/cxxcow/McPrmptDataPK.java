 ...
 */
@Embeddable
public class McPrmptDataPK implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "PRMPT_SEQ_NO")
    private short prmptSeqNo;

    public McPrmptDataPK() {
    }

    public McPrmptDataPK(String authPan, Date authUtDt, int authApprovCd, Date authLocalTs, short prmptSeqNo) {
        this.authPan = authPan;
        this.authUtDt = authUtDt;
        this.authApprovCd = authApprovCd;
        this.authLocalTs = authLocalTs;
        this.prmptSeqNo = prmptSeqNo;
    }
    ...
    public short getPrmptSeqNo() {
        return prmptSeqNo;
    }

    public void setPrmptSeqNo(short prmptSeqNo) {
        this.prmptSeqNo = prmptSeqNo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McPrmptDataPK)) {
            return false;
        }
        McPrmptDataPK other = (McPrmptDataPK) object;
        ...
        if (this.prmptSeqNo != other.prmptSeqNo) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McPrmptDataPK[ authPan=" + authPan + ", authUtDt=" + authUtDt + ", authApprovCd=" + authApprovCd + ", authLocalTs=" + authLocalTs + ", prmptSeqNo=" + prmptSeqNo + " ]";
    }
