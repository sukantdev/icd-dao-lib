...
@Embeddable
public class ProdLimitsUsedPK implements Serializable {
    ...
    public ProdLimitsUsedPK() {
    }

    public ProdLimitsUsedPK(String prduCustId, Character prduCcType, long prduProfileId, int prodcId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProdLimitsUsedPK)) {
            return false;
        }
        ProdLimitsUsedPK other = (ProdLimitsUsedPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.ProdLimitsUsedPK[ prduCustId=" + prduCustId + ", prduCcType=" + prduCcType + ", prduProfileId=" + prduProfileId + ", prodcId=" + prodcId + " ]";
    }
