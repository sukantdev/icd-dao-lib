 ...
 */
@Embeddable
public class McAddLodgAcctPK implements Serializable {
    ...
    public McAddLodgAcctPK() {
    }

    public McAddLodgAcctPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, short p501s3OccInd, int p501s4MsgNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McAddLodgAcctPK)) {
            return false;
        }
        McAddLodgAcctPK other = (McAddLodgAcctPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McAddLodgAcctPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", p501s3OccInd=" + p501s3OccInd + ", p501s4MsgNo=" + p501s4MsgNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
