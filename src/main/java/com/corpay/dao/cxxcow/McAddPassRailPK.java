 ...
 */
@Embeddable
public class McAddPassRailPK implements Serializable {
    ...
    public McAddPassRailPK() {
    }

    public McAddPassRailPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, short p501s3OccInd, int p501s4MsgNo, int d71MsgNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McAddPassRailPK)) {
            return false;
        }
        McAddPassRailPK other = (McAddPassRailPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McAddPassRailPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", p501s3OccInd=" + p501s3OccInd + ", p501s4MsgNo=" + p501s4MsgNo + ", d71MsgNo=" + d71MsgNo + " ]";
    }
