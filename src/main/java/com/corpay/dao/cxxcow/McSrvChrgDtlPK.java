 ...
 */
@Embeddable
public class McSrvChrgDtlPK implements Serializable {
    ...
    public McSrvChrgDtlPK() {
    }

    public McSrvChrgDtlPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo, int d71MsgNo, short occInd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McSrvChrgDtlPK)) {
            return false;
        }
        McSrvChrgDtlPK other = (McSrvChrgDtlPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McSrvChrgDtlPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + ", d71MsgNo=" + d71MsgNo + ", occInd=" + occInd + " ]";
    }
