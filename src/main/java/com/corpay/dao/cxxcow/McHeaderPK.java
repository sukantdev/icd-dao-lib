...
@Embeddable
public class McHeaderPK implements Serializable {
    ...
    public McHeaderPK(short p105s1FileTy, int p105s2FileRDt, long p105s3ProcId, int p105s4FileSeqNo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McHeaderPK)) {
            return false;
        }
        McHeaderPK other = (McHeaderPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McHeaderPK[ p105s1FileTy=" + p105s1FileTy + ", p105s2FileRDt=" + p105s2FileRDt + ", p105s3ProcId=" + p105s3ProcId + ", p105s4FileSeqNo=" + p105s4FileSeqNo + " ]";
    }
