...
@Embeddable
public class McAuthNonFuelInfoPK implements Serializable {
    ...
    private short prdSeqNo;

    public McAuthNonFuelInfoPK() {
    }

    public McAuthNonFuelInfoPK(String authPan, Date authUtDt, int authApprovCd, Date authLocalTs, short prdSeqNo) {
    ...
    public short getPrdSeqNo() {
        return prdSeqNo;
    }

    public void setPrdSeqNo(short prdSeqNo) {
        this.prdSeqNo = prdSeqNo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof McAuthNonFuelInfoPK)) {
            return false;
        }
        McAuthNonFuelInfoPK other = (McAuthNonFuelInfoPK) object;
        ...
        if (this.prdSeqNo != other.prdSeqNo) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.McAuthNonFuelInfoPK[ authPan=" + authPan + ", authUtDt=" + authUtDt + ", authApprovCd=" + authApprovCd + ", authLocalTs=" + authLocalTs + ", prdSeqNo=" + prdSeqNo + " ]";
    }
