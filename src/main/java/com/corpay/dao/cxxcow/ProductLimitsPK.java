...
@Embeddable
public class ProductLimitsPK implements Serializable {
    ...
    public ProductLimitsPK() {
    }

    public ProductLimitsPK(String prdlCustId, Character prdlCcType, long prdlProfileId, int prodcId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProductLimitsPK)) {
            return false;
        }
        ProductLimitsPK other = (ProductLimitsPK) object;
    ...
    public String toString() {
        return "com.corpay.dao.cxxcow.ProductLimitsPK[ prdlCustId=" + prdlCustId + ", prdlCcType=" + prdlCcType + ", prdlProfileId=" + prdlProfileId + ", prodcId=" + prodcId + " ]";
    }
